                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{url('uploadproduct')}}" method="post" enctype="multipart/form-data">
                                ...
                                <input type="number" name="quantity" class="form-control bg-light border-0 small" placeholder="Add product quantity">
                                </div>
                                <div class="mb-4">
                                ...
                                <select id="category" name="category" class="form-control bg-light border-0 small" required>
                                    ...
                                    @endforeach
                                    <!-- Tambahkan lebih banyak pilihan kategori sesuai kebutuhan -->
                                </select>
                                </div>
                                <div class="mb-4">
                                <label>Image</label>
