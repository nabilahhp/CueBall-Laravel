...
<head>
    ...
    <title>Edit Expenses - Admin Panel</title>
    @include('admin.css')
</head>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Your one-stop destination for modifying and updating your store’s expense details swiftly and efficiently.</p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex align-items-center justify-content-between">
                        </div>
                        <div class="card-body">
                            <form action="{{url('updateexpenses',$data->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4">
                                    <label>Source</label>
                                    <input type="text" name="source" class="form-control bg-light border-0 small" value="{{$data->source}}">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label>Amount</label>
                                    <input type="text" name="amount" class="form-control bg-light border-0 small" value="{{$data->amount}}">
                                </div>
                                <div class="mb-4">
                                    <label>Date</label>
                                    <input type="date" name="date" class="form-control bg-light border-0 small" value="{{$data->date}}">
                                </div>
                                <div class="mb-4">
