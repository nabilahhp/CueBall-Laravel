                        ...
                        <div class="card-body">
                            <form action="{{url('updatecustomer',$customer->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control bg-light border-0 small" placeholder="Add user name" value="{{$customer->name}}" required>
                                </div>
                                <div class="mb-4">
                                    <label>Email</label>
                                    <input type="text" name="email" class="form-control bg-light border-0 small" placeholder="Add your email" value="{{$customer->email}}" required>
                                </div>
                                <div class="mb-4">
                                    <label>Phone</label>
                                    <input type="text" name="phone" class="form-control bg-light border-0 small" placeholder="Add your phone" value="{{$customer->phone}}" required>
                                </div>
                                <div class="mb-4">
                                    <label>Address</label>
                                    <input type="text" name="address" class="form-control bg-light border-0 small" placeholder="Add your address" value="{{$customer->address}}" required>
                                </div>
                            <div class="mb-4">
                                <label>User Type</label>
                                <select name="usertype" class="form-control bg-light border-0 small" required>
                                    <option value="Admin" {{ $customer->usertype == 'admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="User" {{ $customer->usertype == 'user' ? 'selected' : '' }}>User</option>
                                </select>
                            </div>
                            <div class="mb-4">
