                    ...
                    <div class="card shadow mb-4">
                       ...
                       <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <td>
                                    <a href="{{url('edituser', $users->id)}}" class="btn btn-info btn-circle btn-sm edit-btn">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="{{url('deleteuser', $users->id)}}" class="btn btn-danger btn-circle btn-sm" title="Delete" onclick="confirmation(event)">
