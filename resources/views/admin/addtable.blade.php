        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Billiard Table</h1>
                    <p class="mb-4">Designed for quick and accurate addition of new billiard tables to your store’s inventory.”</p>
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <form action="{{url('uploadtable')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="capacity" class="form-control bg-light border-0 small" placeholder="Add table capacity" required>
                                </div>
                                <div class="mb-4">
                                <label for="category">Category</label>
                                <select id="category" name="category" class="form-control bg-light border-0 small" required>
                                    <option value="category1">Select a Option</option>
