                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex align-items-center justify-content-between">
                            <h5 class="m-0 font-weight-bold text-primary">Billiard Table Payment</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="Table" class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img height="120" width="120" src="/products/{{$bayar->bukti}}">
                                            </td>
                                            <td>{{ $bayar->tgl_upload }}</td>
                                            <td>{{ $bayar->konfirmasi }}</td>
                                            <td>
                                                <a href="{{url('editbayar', $bayar->idbayar)}}" class="btn btn-info btn-circle btn-sm edit-btn">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <a href="{{ url('deletebayar', $bayar->idbayar) }}" class="btn btn-danger btn-circle btn-sm" title="Delete" onclick="confirmation(event)">
