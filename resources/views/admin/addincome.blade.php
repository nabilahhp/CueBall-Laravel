        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Income</h1>
                    <p class="mb-4">A simple and intuitive interface designed to help you record new income quickly and accurately.</p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex align-items-center justify-content-between">
                        </div>
                        <div class="card-body">
                            <form action="{{url('uploadincome')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4">
                                <label>Source</label>
